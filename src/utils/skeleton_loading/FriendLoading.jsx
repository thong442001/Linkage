    ...
    <SkeletonPlaceholder>
         ...
         <View style={HomeS.postBox}>
                  <View style={HomeS.postHeader}>
                    <View style={{flex: 1,flexDirection: 'row' , alignItems: 'baseline', justifyContent: 'space-between', marginHorizontal: 20,}}>
...
const HomeS = StyleSheet.create({
    ...
    timePlaceholder1:{
        ...
        width: width * 0.30, // Tỷ lệ theo chiều rộng màn hình
        height: 15,
        borderRadius: 4,
        backgroundColor: '#E0E0E0',
        marginTop: 5,
    ...
    timePlaceholder: {
      width: width * 0.20, // Tỷ lệ theo chiều rộng màn hình
      height: 15,
      borderRadius: 4,
      backgroundColor: '#E0E0E0',
      marginTop: 5,
