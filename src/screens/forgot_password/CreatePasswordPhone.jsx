...
const CreatePasswordPhone = (props) => {
    ...
    const handleCreatePassword = async () => {
        ...
        try {
            ...
            const response = await dispatch(quenMatKhau_phone({ phone, passwordNew })).unwrap();
            console.log("Response từ quenMatKhau_phone:", response);
...
export default CreatePasswordPhone;